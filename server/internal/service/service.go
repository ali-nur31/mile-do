...
func NewAuthService(repo repo.Querier, pool *pgxpool.Pool, userService UserService, tokenManager AuthTokenManager, refreshTokenService RefreshTokenService, passwordManager AuthPasswordManager) AuthService {
	return &authService{
		repo:                repo,
		pool:                pool,
		userService:         userService,
